class CfgPatches {
    class B_TLM_BLU {
        units[] = {
            "B_TLM_Rifleman_M14_BLU_01",
            "B_TLM_Rifleman_AKM_BLU_01",
            "B_TLM_Rifleman_M16A2_BLU_01",
            "B_TLM_Rifleman_RPG_BLU_01",
            "B_TLM_Grenadier_GP25_BLU_01",
            "B_TLM_Marksman_M14_wScope_BLU_01",
            "B_TLM_Machine_Gunner_M60E3_BLU_01",
            "B_TLM_Medic_AKMS_BLU_01",
            "B_TLM_Engineer_AKMS_BLU_01",
            "B_TLM_Leader_GP25_BLU_01"
        };
        weapons[] = {};
